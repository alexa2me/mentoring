import "../style/cachoeira.css";
import cachoeira from "../assets/cachoeira.avif";


const Cachoeira = (props) => {
  return (
    <div className="container">
      <div className="card-cachoeira">
        <div className="card-header">
            <img className="card-perfil" src={props.fotoPerfil} alt="foto de perfil" />
            <p>{props.titulo}</p>
        </div>
        <img className="card-imagem" src={cachoeira} alt={props.alt} />
